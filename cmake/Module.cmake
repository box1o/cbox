...
function(add_module module_name)
    ...
    # Define target
    set(target_name cbox_${module_name})
    add_library(${target_name} ${lib_type} ${ARG_SOURCES} ${ARG_HEADERS})
    add_library(cbox::${module_name} ALIAS ${target_name})

    # Register that a library target exists
    set_property(GLOBAL PROPERTY CBOX_HAS_LIBRARY_TARGETS TRUE)

    # Basic target metadata
    set_target_properties(${target_name} PROPERTIES
        VERSION ${PROJECT_VERSION}
        SOVERSION ${PROJECT_VERSION_MAJOR}
        OUTPUT_NAME cbox_${module_name}
    ...
    # cbox_set_target_options(${target_name})
