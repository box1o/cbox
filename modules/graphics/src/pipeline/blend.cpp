    ...
    for (u32 i = 0; i < attachment_count && i < 8; ++i) {
        ...
        if (att.enabled) {
            ...
            glBlendFuncSeparatei(i,
                ToGLBlendFactor(att.src_color), ToGLBlendFactor(att.dst_color),
        ...
        glColorMaski(i,
            att.color_write_r ? GL_TRUE : GL_FALSE,
            att.color_write_g ? GL_TRUE : GL_FALSE,
            att.color_write_b ? GL_TRUE : GL_FALSE,
